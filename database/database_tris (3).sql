...
CREATE TABLE `players` (
  ...
  `last_online` date NOT NULL DEFAULT current_timestamp() COMMENT 'value to check if the player is online in recent seconds'
...
INSERT INTO `players` (`player_id`, `nickname`, `password`, `match_id`, `is_online`, `last_online`) VALUES
(1, 'admin', '1234', NULL, 0, '2023-07-25');
...
--
ALTER TABLE `players`
  MODIFY `player_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Player''s primary key', AUTO_INCREMENT=62;
