...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2023 at 12:47 PM
...
(1, 'admin', '1234', NULL, NULL, 0, '2023-07-25 00:00:00');
...
--
ALTER TABLE `players`
  MODIFY `player_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Player''s primary key', AUTO_INCREMENT=63;
